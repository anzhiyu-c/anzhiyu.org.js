...
top_img: https://img02.anzhiy.cn/adminuploads/1/2023/04/09/6432a8a257cec.webp!topimg
cover: https://img02.anzhiy.cn/adminuploads/1/2023/04/09/6432a8a257cec.webp!cover
comments:
top_group_index: 5
ai:
  - 本教程介绍了 AnZhiYu 主题的各种页面配置方法，包括标签页、分类页、友情链接、关于页面、相册页面、朋友圈页面、音乐馆页、404 页面、追番页面和留言板页面。其中介绍了 Front-matter 的基本认识，以及用于页面和文章页配置的参数，例如页面标题、标签分类、关键字、页面评论模块等。此外，教程还介绍了如何配置首页轮播图和推荐卡片，以及分类页的排序方式和是否显示评论、顶部图等。
  - 该文章为一篇主题安装文档，介绍了如何安装AnZhiYu主题，包括安装pug和stylus渲染插件以及配置文件的修改。在安装过程中，需要注意主题版本选择，可以参考作者提供的视频教程或提交问题到仓库中获得技术支持。本教程更新于年月日，针对最新的主题版本。
  - 本教程介绍了博客主题Front-matter的基本知识和配置方法，包括标签页、分类页、首页即刻说说页面配置、友情链接配置、关于页面配置、相册页面配置、朋友圈页面配置、音乐馆页配置、404页面和留言板页面。同时，还对文章页的配置进行了详细介绍，包括文章标题、创建日期、更新日期、标签、分类、关键字、描述、顶部图片、缩略图、评论模块、简洁模式和版权模块等。此外，还介绍了首页轮播图、右侧卡片组、文章背景色、标签页、分类页等各项配置方法。最后，主题配置文件中还添加了全局音乐动画、搜索支持缩略图显示和歌曲推荐等功能。
  - 本文介绍了一个博客主题的基本认识和各配置页面的设置方法，包括标签页、分类页、首页、友情链接、关于页、相册页、朋友圈页、音乐馆页、404页和追番页等。文章和页面的配置内容包括标题、日期、标签、分类、关键字、描述、顶部图片、评论模块、版权模块等。同时还介绍了博客中的一些功能和特点，如首页轮播图、卡片组、文章背景、音乐支持、打赏功能、搜索支持、缩略图显示和歌曲推荐等。该主题的配置文件中开启了中文支持。
---
...
在主题配置文件中修改`envelope_comment`，改为`enable: true`，更多配置请查看[信笺样式留言板](https://akilar.top/posts/e2d3c450/)
